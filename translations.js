...
const translations = {
    en: {
        ...
        services: {
            ...
            title2: "YOUR BUSINESS PROBLEMS",
            problem1: {
                title: "Confused about where to start importing?",
                desc: "We guide you through every step of the import process from start to finish."
            },
            problem2: {
                title: "Limited Mandarin language skills?",
                desc: "Our bilingual team handles all communication with Chinese suppliers for you."
            },
            problem3: {
                title: "High minimum order quantity concerns?",
                desc: "We help negotiate flexible MOQ terms that suit your business needs."
            },
            problem4: {
                title: "Worried about product damage during shipping?",
                desc: "We ensure secure packaging and reliable shipping to protect your products."
            }
        },
        why: {
            title1: "WHY CHOOSE OLA",
            title2: "AS YOUR BUSINESS PARTNER?",
            feature1: {
    ...
    id: {
        ...
        services: {
            ...
            title2: "MASALAH BISNISMU",
            problem1: {
                title: "Bingung mulai impor dari mana?",
                desc: "Kami memandu Anda melalui setiap langkah proses impor dari awal hingga akhir."
            },
            problem2: {
                title: "Keterbatasan bahasa Mandarin?",
                desc: "Tim bilingual kami menangani semua komunikasi dengan supplier China untuk Anda."
            },
            problem3: {
                title: "Kendala minimal pemesanan yang tinggi?",
                desc: "Kami membantu menegosiasikan persyaratan MOQ yang fleksibel sesuai kebutuhan bisnis Anda."
            },
            problem4: {
                title: "Khawatir keamanan barang rusak saat pengiriman?",
                desc: "Kami memastikan pengemasan yang aman dan pengiriman yang terpercaya untuk melindungi produk Anda."
            }
        },
        why: {
            title1: "KENAPA HARUS PILIH OLA",
            title2: "SEBAGAI PARTNER BISNISMU?",
            feature1: {
                title: "One Stop Solution",
